      ...
      <header className="bg-[#111111] text-[#F4F3F0] border-b border-[#F4F3F0]/20 px-[2rem] h-16 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-6">
          ...
          <nav className="hidden md:flex items-center gap-1">
            <Link href="/admin" className="px-3 py-1.5 text-[11px] font-[700] tracking-[0.1em] uppercase text-[#F4F3F0]/60 hover:text-[#F4F3F0] transition-none" style={{ fontFamily: "var(--font-space-mono)" }}>
              PANEL
            </Link>
            <Link href="/admin/kullanicilar" className="px-3 py-1.5 text-[11px] font-[700] tracking-[0.1em] uppercase text-[#F4F3F0]/60 hover:text-[#F4F3F0] transition-none" style={{ fontFamily: "var(--font-space-mono)" }}>
              KULLANICILAR
            </Link>
            <Link href="/admin/atolyeler" className="px-3 py-1.5 text-[11px] font-[700] tracking-[0.1em] uppercase text-[#F4F3F0]/60 hover:text-[#F4F3F0] transition-none" style={{ fontFamily: "var(--font-space-mono)" }}>
              ATÖLYELER
            </Link>
          </nav>
        </div>
